...
dmxMidiCtrlNg: $(SOURCES) $(HEADERS) main.c main.h dmx_globvar.c dmx_globvar.h dmx_luaqueue.c dmx_luaqueue.h dmx_output.c dmx_output.h dmx_selector.c dmx_selector.h dmx_image.c dmx_image.h dmx_devices.c dmx_devices.h dmx_channels.c dmx_channels.h dmx_queue.c dmx_queue.h Makefile 
	@clear
	@rm -f dmxMidiCtrlNg
	@echo "  \033[1;34mCompile\033[0m"
	@$(COMPILER) main.c dmx_globvar.c dmx_output.c dmx_luaqueue.c dmx_selector.c dmx_queue.c dmx_image.c dmx_devices.c dmx_channels.c $(SOURCES) -o dmxMidiCtrlNg $(FLAGS) $(LDFLAGS) 
